...
$TextStylesThemeCopyWith<TextStylesTheme> get copyWith => _$TextStylesThemeCopyWithImpl<TextStylesTheme>(this as TextStylesTheme, _$identity);
...
/// @nodoc
abstract mixin class $TextStylesThemeCopyWith<$Res>  {
...
/// @nodoc
class _$TextStylesThemeCopyWithImpl<$Res>
    implements $TextStylesThemeCopyWith<$Res> {
  _$TextStylesThemeCopyWithImpl(this._self, this._then);

  final TextStylesTheme _self;
  final $Res Function(TextStylesTheme) _then;
...
as TextStyle,buttonText: null == buttonText ? _self.buttonText : buttonText // ignore: cast_nullable_to_non_nullable
as TextStyle,hint: null == hint ? _self.hint : hint // ignore: cast_nullable_to_non_nullable
as TextStyle,small: null == small ? _self.small : small // ignore: cast_nullable_to_non_nullable
as TextStyle,snackbar: null == snackbar ? _self.snackbar : snackbar // ignore: cast_nullable_to_non_nullable
as TextStyle,
  ));
}
...
@override final  TextStyle buttonText;
@override final  TextStyle hint;
@override final  TextStyle small;
@override final  TextStyle snackbar;

/// Create a copy of TextStylesTheme
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$TextStylesThemeCopyWith<_TextStylesTheme> get copyWith => __$TextStylesThemeCopyWithImpl<_TextStylesTheme>(this, _$identity);
...
/// @nodoc
abstract mixin class _$TextStylesThemeCopyWith<$Res> implements $TextStylesThemeCopyWith<$Res> {
...
/// @nodoc
class __$TextStylesThemeCopyWithImpl<$Res>
    implements _$TextStylesThemeCopyWith<$Res> {
  __$TextStylesThemeCopyWithImpl(this._self, this._then);

  final _TextStylesTheme _self;
  final $Res Function(_TextStylesTheme) _then;
